...
const stories = [
  ...
  },
  {
    ...
    time: "6m",
    quote:
      "The work was steady on the shift, the targets were clear, and I knew what was expected. After a few weeks the client asked to keep me on permanently. Shifts stayed consistent.",
  ...
  },
  {
    ...
    time: "Ongoing",
    quote:
      "I started covering different shifts, then it turned into the same client most weeks. It's easier when you know the site, the rules and the route. Shifts stayed consistent.",
  ...
  },
  {
    ...
    time: "14w",
    quote:
      "The training was done properly, not rushed. Once I passed, I moved onto FLT duties full-time and it felt like a proper step up. Shifts stayed consistent.",
  ...
  },
  {
    ...
    time: "10w",
    quote:
      "I was already confident on FLT, but the placement matched my experience. After a short time I was trusted with tighter aisles and higher value stock. Shifts stayed consistent.",
  ...
  },
  {
    ...
    time: "12w",
    quote:
      "No one over-sold the job. I knew the hours, breaks and pace before I started, and that helped me settle in. It turned into a longer-term role quickly.",
  ...
  },
  {
    ...
    time: "Ongoing",
    quote:
      "The job is busy, but it's consistent. Good planning, realistic times, and support if anything changes on the day meant I kept getting booked back in. Shifts stayed consistent.",
  ...
  return (
    <section className="relative flex min-h-[70vh] w-full items-center justify-center overflow-hidden bg-navy-900 pt-32 pb-24">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
        ...
        >
          From temp to permanent. From picker to team leader. Real journeys from
          real workers.
        </motion.p>
      </div>
          ...
          {stories.map((story, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-teal-5/10 border border-teal-5/20 text-teal-4 text-[10px] font-semibold uppercase tracking-widest">
                  <span className="w-1.5 h-1.5 rounded-full bg-teal-5" />
                  {story.badge}
                </span>
                <span className="text-[#8B98AB]/30 text-[10px] font-semibold uppercase tracking-widest">
                  {story.time}
                </span>
              </div>
              <div className="flex items-center gap-4 mb-5">
                <div className="w-12 h-12 rounded-full bg-teal-5/10 border border-teal-5/20 flex items-center justify-center text-teal-5 group-hover:bg-[#00A99D] group-hover:text-white transition-all shrink-0">
                  <IconUser size={20} />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 text-[#8B98AB]/50 text-xs font-semibold">
              ...
              <div className="relative flex-grow mb-6">
                <IconQuote
                  size={16}
                  className="text-white/10 absolute -top-1 -left-1"
                />
                <p className="text-[#8B98AB] text-sm leading-relaxed font-medium pl-4 italic">
              ...
              <div className="flex flex-wrap gap-2 pt-5 border-t border-white/5">
                {story.tags.map((tag, j) => (
                  <span
                    key={j}
                    className="px-3 py-1 rounded-full bg-white/5 text-[#8B98AB]/50 text-[10px] font-semibold uppercase tracking-widest"
                  >
                    {tag}
                  </span>
                ))}
    ...
    <section className="py-20 bg-navy-700">
      <div className="mx-auto max-w-3xl px-6 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass-card rounded-2xl p-12 border-teal-5/20 bg-gradient-to-br from-teal-5/10 to-transparent"
        >
          <h3 className="text-white text-3xl md:text-4xl font-semibold tracking-tight mb-4">
            And Many More...
          </h3>
          <p className="text-[#8B98AB] text-lg font-medium">
            These are just a few of the thousands of workers we&apos;ve helped
        ...
        <div className="glass-card rounded-2xl p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h4 className="text-white text-2xl font-semibold mb-2">
              Looking for Reliable Workers Like These?
            </h4>
            <p className="text-[#8B98AB] font-medium">
              We supply the workers who show up, hit targets, and stick around.
            </p>
          </div>
          <Link
            href="/get-started"
            className="shrink-0 px-10 py-5 rounded-full bg-teal-5 text-black font-semibold uppercase tracking-widest text-xs hover:bg-white transition-all shadow-xl shadow-teal-5/20 flex items-center gap-3"
          >
  ...
  return (
    <main className="bg-navy-900 min-h-screen">
      ...
      <CtaBanner
        ...
        subtitle="Join thousands of workers who found consistent shifts, fair pay, and real career progression with Accept."
        primaryButtonText="Register for Work"
        secondaryButtonText="Browse Current Jobs"
