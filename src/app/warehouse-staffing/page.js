    ...
    <section className="relative flex min-h-[80vh] w-full items-center justify-center overflow-hidden bg-navy-900 pt-32 pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-8 inline-flex items-center gap-2 rounded-full border border-teal-5/30 bg-teal-5/10 px-4 py-2">
          ...
          <span className="text-sm font-semibold text-teal-4">Warehouse Staffing</span>
        </motion.div>
        ...
        <motion.div className="flex flex-wrap justify-center gap-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
          <Button variant="primary" size="lg" href="/get-started">Find Warehouse Staff</Button>
          <Button variant="secondary" size="lg" href="/jobs">View Current Jobs</Button>
        </motion.div>
      </div>
...
function HeroStats() {
  const stats = [
    { value: "500+", label: "Warehouse Workers Daily", sub: "Across the Midlands" },
    { value: "98%", label: "Fill Rate", sub: "Consistent delivery" },
    { value: "99%", label: "Attendance Rate", sub: "Workers who show up" },
    { value: "4hrs", label: "Average Response Time", sub: "Emergency cover" },
  ];
  return (
