    ...
    <section className="relative flex min-h-[80vh] w-full items-center justify-center overflow-hidden bg-navy-900 pt-32 pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
        ...
        <h1 className="sr-only">
          Permanent Recruitment Agency in the Midlands
        </h1>
        <motion.h2
        ...
        >
          25 years finding operations talent. 12-week replacement guarantee.
          Quality shortlists, not quantity.
        </motion.p>
...
function HeroStats() {
  const stats = [
    ...
    { value: "25+", label: "Years Experience", sub: "Operations recruitment" },
    {
      ...
      sub: "Still there after 12 months",
    },
  ];
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-white/60 mb-6">
              You&apos;ve felt it. The sinking feeling when your new hire
              isn&apos;t working out. Three months in, everyone knows — but
              you&apos;ve already invested thousands.
            </p>
            <p className="text-lg leading-relaxed text-white/60">
              Salary, training, lost productivity, re-hiring costs. A bad
              permanent hire bleeds money for months before you cut losses.
            </p>
          </motion.div>
  ...
  const steps = [
    {
      ...
      desc: "We screen hundreds so you only see the top 3. No generic CV dumps.",
      icon: IconSearch,
    },
    {
      title: "12-Week Guarantee",
      desc: "If they aren't right, we find someone who is. Zero cost to you.",
      icon: IconShieldCheck,
    },
    {
      title: "Pay When It Works",
      desc: "Success-based fees. We only win when you find your perfect hire.",
      icon: IconCash,
    },
    {
      title: "End-to-End Management",
      desc: "From first contact to start date, we handle the logistics.",
      icon: IconClock,
    },
  ];
  ...
  const roles = [
    {
      ...
      desc: "Running the whole show. Strategic & tactical leadership.",
      icon: IconBriefcase,
    },
    {
      title: "Transport Managers",
      desc: "Compliance, routing, and fleet leadership experts.",
      icon: IconTruck,
    },
    {
      title: "Warehouse Supervisors",
      desc: "Shift leaders who know how to motivate and hit targets.",
      icon: IconBuildingFactory,
    },
    {
      title: "Planners & Clerks",
      desc: "The organisational backbone of your logistics loop.",
      icon: IconClock,
    },
    {
      title: "Commercial & Admin",
      desc: "Customer service and back-office operations talent.",
      icon: IconUserSearch,
    },
    {
      title: "Production Leads",
      desc: "Line management for manufacturing environments.",
    ...
    <section className="relative w-full bg-[#0d111a] py-24 md:py-32 font-sans overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6">
        ...
        >
          ...
          <p className="mt-6 text-lg text-white/60 leading-relaxed max-w-2xl mx-auto">
            25 years of specialist experience in operations and logistics
            recruitment.
          </p>
        </motion.div>
          ...
          {roles.map((r, i) => (
            ...
            >
              ...
              <div className="relative flex items-start gap-5 mb-4">
                ...
                <div>
                  <h3 className="text-white font-semibold text-[22px] leading-tight mb-1">
                    {r.title}
                  </h3>
                </div>
              </div>
  ...
  return (
    <section className="relative w-full bg-navy-700 py-24 md:py-32 font-sans overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
        ...
        >
          We don&apos;t flood your inbox with CVs. We find 3 people who can
          actually do the job. Because we know the roles, we know the sector,
          and we know what &ldquo;good&rdquo; looks like in operations.
        </motion.p>
        <motion.div
...
// ─── Main ───────────────────────────────────────────────────────────────────
export default function PermanentRecruitmentClient() {
  return (
