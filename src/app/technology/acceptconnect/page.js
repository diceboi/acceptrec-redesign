  ...
  return (
    <section className="relative flex min-h-[75vh] w-full flex-col items-center justify-center overflow-hidden bg-[#0d1522] pt-48 pb-16 border-b border-white/5">
      ...
      <div className="relative z-10 mx-auto max-w-285 px-6 text-center">
        ...
        >
          No more WhatsApp chaos. No more missed messages. One platform where every worker is connected, informed, and ready to go.
        </motion.p>
      </div>
    </section>
  );
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    <div>
                        ...
                        <div className="space-y-4">
                            {problems.map((p, i) => (
                                <div key={i} className="flex gap-4 p-6 rounded-2xl bg-white/5 border border-white/5 group hover:bg-white/[0.07] transition-all">
                                    ...
                                    <p className="text-white/70 font-medium text-sm leading-relaxed">{p}</p>
                                </div>
                            ))}
                        </div>
                    </div>
...
function ProcessSection() {
    const steps = [
        { title: "Everyone Joins", icon: IconDeviceMobile, desc: "Workers download the app or use the web version. One login. They're connected." },
        { title: "You Send Messages", icon: IconMessage2, desc: "Broadcast to everyone, specific sites, or individuals. Instant delivery with full read receipts." },
        { title: "Workers Informed", icon: IconBellRinging, desc: "Shift reminders, confirmations, and updates — all in one centralized feed. No digging through chats." }
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                        ...
                        <div className="lg:col-span-7 p-8 md:p-20 relative overflow-hidden">
                             ...
                             <div className="space-y-4 max-w-lg">
                                ...
                                <div className="p-4 rounded-xl bg-white/5 border border-white/5 flex justify-between items-center opacity-40">
                                     <div className="text-[11px] text-white/60 font-medium">Broadcast: "Induction Docs Ready"</div>
                        ...
                        <div className="lg:col-span-5 bg-linear-to-b from-[#1c2436] to-[#161b28] p-12 lg:p-20 border-l border-white/5">
                             ...
                             <div className="space-y-8">
                                {[
                                    { t: "Mass Communication", d: "One message to 100 workers in seconds. Filter by site, role, or shift.", i: IconBroadcast },
                                    { t: "Individual Messaging", d: "Secure, direct messaging with full historical thread visibility.", i: IconUsers },
                                    { t: "Shift Confirmations", d: "Watch confirmations roll in real-time. No more guessing who's showing up.", i: IconHistory },
                                    { t: "Automated Reminders", d: "Set it and forget it. System-sent reminders reduce missing shifts.", i: IconClock }
                                ].map((item, i) => (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-7">
                        ...
                        <p className="text-white/60 text-xl leading-relaxed mb-10">
                            Workers have questions at all hours. AcceptConnect includes The Coach — an AI assistant that handles common queries instantly.
                        </p>
