    ...
    <section className="relative flex min-h-[75vh] w-full flex-col items-center justify-center overflow-hidden bg-[#0d1522] pt-48 pb-16 border-b border-white/5">
      ...
      <div className="relative z-10 mx-auto max-w-285 px-6 text-center">
        ...
        >
          ...
          <span className="text-[11px] font-bold tracking-[0.2em] uppercase text-teal-5 text-glow-teal">AI-Powered Matching Engine</span>
        </motion.div>
        ...
        >
          AcceptMatch — The <br /><span className="text-teal-5 text-glow-teal">Right Worker. Every Time.</span>
        </motion.h1>
        ...
        <section className="py-24 bg-[#0d1522] border-y border-white/5">
            <div className="mx-auto max-w-285 px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-white/40 text-lg leading-relaxed italic">Gut feel gets you bodies. Data gets you the right people.</p>
                </div>
                
                <div className="overflow-x-auto rounded-[40px] border border-white/10 shadow-2xl bg-[#161b28]">
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr className="bg-white/5 border-b border-white/10">
                                <th className="p-8 text-white text-sm font-bold uppercase tracking-widest">Factor</th>
                                <th className="p-8 text-white/40 text-sm font-bold uppercase tracking-widest">Traditional</th>
                                <th className="p-8 bg-teal-5/10 text-teal-4 text-sm font-black uppercase tracking-widest border-l border-white/10">AcceptMatch</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-white/5">
                            {rows.map((row, i) => (
                                <tr key={i} className="group hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="p-8 text-white/40 text-sm font-medium">{row.t}</td>
        ...
        <section className="py-24 bg-[#0d111a] border-b border-white/5">
             <div className="mx-auto max-w-285 px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {pillars.map((p, i) => (
                        <div key={i} className={`p-10 rounded-[32px] bg-[#161b28] border border-white/5 hover:border-teal-5/20 transition-all group ${i === 3 || i === 4 ? 'lg:col-span-1.5' : ''}`}>
                        ...
                        <div className="lg:col-span-5 p-12 lg:p-20 bg-linear-to-b from-[#1c2436] to-[#161b28] border-r border-white/5">
                            ...
                            <div className="p-6 rounded-2xl bg-white/5 border border-white/5 mb-8">
                                <div className="flex items-center justify-between mb-4">
                                    <span className="text-white/40 text-xs font-bold uppercase tracking-widest">Active Role</span>
                                ...
                                <div className="text-white/30 text-xs font-medium">6am Start • Zone B • FLT Required</div>
                            </div>
                            <p className="text-white/40 leading-relaxed text-sm mb-0 italic">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="text-white font-bold flex items-center gap-2">
                                                    {c.name}
                                                    {i === 0 && <span className="text-[9px] text-teal-4 font-black px-1.5 py-0.5 bg-teal-5/10 border border-teal-4/20 rounded">TOP MATCH</span>}
                                                </div>
                                                <div className="text-[10px] text-white/30 uppercase font-black tracking-widest">{c.stats}</div>
                                            </div>
                                        </div>
        ...
        <section className="py-24 bg-[#0d1522] border-y border-white/5">
            <div className="mx-auto max-w-285 px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-white/40 text-lg leading-relaxed">Technology assists, but doesn't replace recruitment judgment.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {steps.map((s, i) => (
                        <div key={i} className="relative p-10 rounded-[32px] bg-[#161b28] border border-white/5 text-center">
                            <div className="w-12 h-12 rounded-full bg-teal-5/10 flex items-center justify-center text-teal-4 font-black mx-auto mb-6 border border-teal-5/20">
                                {i + 1}
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="order-2 lg:order-1 flex justify-center">
                        <div className="w-full max-w-[440px] aspect-square rounded-full border-2 border-dashed border-white/5 flex items-center justify-center relative p-20">
                             ...
                             <div className="relative z-10 w-full h-full rounded-full bg-[#161b28] border border-white/5 flex flex-col items-center justify-center text-center p-8 shadow-2xl">
                                ...
                                <p className="text-white/30 text-sm leading-relaxed">Every shift completes the data cycle, making the engine smarter.</p>
                             </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                <div key={i} className="flex gap-4">
                                    ...
                                    <div>
                                        <h5 className={`font-black text-xs uppercase tracking-widest mb-1 ${item.c}`}>{item.t}</h5>
                                        <p className="text-white/40 text-sm leading-relaxed">{item.d}</p>
                                    </div>
                                </div>
                            ))}
