  ...
  return (
    <section className="relative flex min-h-[80vh] w-full flex-col items-center justify-center overflow-hidden bg-navy-900 pt-32 pb-16">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
        ...
        >
          <span className="text-[11px] font-bold tracking-[0.2em] uppercase text-teal-5">Client Portal</span>
        </motion.div>
        ...
        >
          Your Workforce Data. <br /><span className="text-teal-5">Real-Time.</span>
        </motion.h1>
...
function DashboardMockup() {
    ...
    return (
        <section className="py-24 bg-[#0d111a]">
            <div className="mx-auto max-w-[1140px] px-6">
                <div className="bg-white/[0.03] rounded-2xl border border-white/5 p-8 md:p-16 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
                        <div>
                            ...
                            <p className="text-[#8B98AB] text-sm font-medium tracking-wide">Live Workforce Intelligence</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                        {[
                            ...
                            <div key={i} className="p-8 rounded-2xl bg-white/5 border border-white/5">
                                ...
                                <div className="text-[#8B98AB] text-[11px] font-bold uppercase tracking-widest">{stat.label}</div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                         {/* Activity feed */}
                        <div className="lg:col-span-1 p-8 rounded-2xl bg-white/5 border border-white/5 h-full">
                            ...
                            <div className="space-y-6">
                                {activities.map((act, i) => (
                                    <div key={i} className="relative pl-6 before:absolute before:left-0 before:top-2 before:bottom-[-24px] before:w-0.5 before:bg-white/5 last:before:hidden">
                                        ...
                                        <div className="text-white text-xs font-bold mb-1">{act.user} <span className="text-[#8B98AB] font-normal">{act.action}</span></div>
                                        <div className="text-[10px] text-teal-5 uppercase font-bold tracking-widest mb-1">{act.time}</div>
                                        <div className="text-[9px] text-[#8B98AB]/70 uppercase font-bold">{act.site}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-2 p-8 rounded-2xl bg-white/5 border border-white/5">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <div className="flex gap-2">
                                    {[7, 30, 90].map(d => (
                                        <button key={d} className={`text-[9px] font-bold uppercase px-2 py-1 rounded ${d === 7 ? 'bg-teal-5 text-white' : 'text-[#8B98AB] hover:text-white'}`}>
                                            {d}D
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div className="h-64 flex items-end justify-between gap-2">
                                {[65, 80, 45, 90, 85, 70, 95].map((h, i) => (
                                    <motion.div 
                                        ...
                                        className="w-full bg-gradient-to-t from-teal-5/40 to-teal-5 rounded-t-lg group relative"
                                    >
...
function SelfServiceSection() {
    ...
    const feed = [
        ...
        { user: "Weekly report ready", action: "", time: "Just now", icon: IconFileText, color: "text-[#8B98AB]" },
    ];
        ...
        <section className="py-24 bg-[#0d111a]">
            <div className="mx-auto max-w-[1140px] px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            ...
                            {items.map((item, i) => (
                                <div key={i} className="flex items-start gap-4">
                                    ...
                                    <p className="text-white/80 font-medium">
                                        "{item.q}" — <span className="text-[#8B98AB] font-normal">{item.a}</span>
                                    </p>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="bg-white/[0.03] rounded-2xl border border-white/5 p-8 shadow-2xl relative overflow-hidden group max-w-lg mx-auto lg:mr-0">
                                ...
                                <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            {f.action && <div className="text-[#8B98AB] text-[10px] uppercase font-bold tracking-widest">{f.action}</div>}
                                        </div>
                                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {features.map((f, i) => (
                        <div key={i} className="p-10 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-teal-5/20 transition-all group">
                            ...
                            <p className="text-[#8B98AB] text-sm leading-relaxed">{f.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
...
function QuickRequestSection() {
    ...
    return (
        <section className="py-24 bg-navy-900">
            <div className="mx-auto max-w-[1140px] px-6">
                <div className="bg-white/[0.03] rounded-2xl border border-white/5 p-8 md:p-20 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <h2 className="text-white text-4xl md:text-5xl font-bold mb-4 tracking-tight leading-tight">
                                ...
                                <span className="text-teal-5">Click. Done.</span>
                            </h2>
                            <p className="text-[#8B98AB] text-lg leading-relaxed mb-12 max-w-lg">
                        ...
                        <div className="bg-[#0d111a] rounded-2xl border border-white/5 p-8 md:p-10 shadow-xl max-w-md mx-auto lg:mr-0 w-full">
                            ...
                            <div className="space-y-6">
                                ...
                                <a href="/get-started" className="w-full py-4 rounded-xl bg-teal-5 hover:bg-teal-6 text-white font-bold transition-all shadow-lg shadow-teal-5/20 flex items-center justify-center gap-2 group/btn">
        ...
        <section className="py-24 bg-navy-900">
            <div className="mx-auto max-w-[1140px] px-6">
                <div className="max-w-3xl mb-16">
                    ...
                    <p className="text-[#8B98AB] text-lg">Stop waiting for emails. Our portal gives you the answers to your most common questions before you even ask them.</p>
                </div>
                <div className="space-y-4">
                    {questions.map((q, i) => (
                        <motion.div 
                            ...
                            className="p-8 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between group hover:bg-white/[0.07] transition-all cursor-default"
                        >
