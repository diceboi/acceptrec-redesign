...
const whyUs = [
  {
    ...
    title: "Reliable Pay",
    desc: "Weekly pay, always on time. No hassle, no excuses. We've never missed a payroll since 2015.",
  },
  {
    icon: IconCalendarCheck,
    title: "Consistent Work",
    desc: "Work with good employers who need reliable people. We match you with businesses that offer regular shifts.",
  },
  {
    icon: IconMapPin,
    title: "Local Jobs",
    desc: "Work in Leicester and the surrounding area. No ridiculous commutes - we find you work close to home.",
  },
];
...
const steps = [
  {
    icon: IconUserPlus,
    title: "Register",
    desc: "Come to our office or call us. We'll need some basic details, proof of ID, and your right to work documents. Takes about 30 minutes.",
  },
  {
    icon: IconTargetArrow,
    title: "Get Matched",
    desc: "We'll find you work that matches your skills, location, and availability. No time-wasting - we only call when we have real shifts.",
  },
  {
    icon: IconBriefcase,
    title: "Start Work",
    desc: "Show up on time, do good work, and you'll get consistent shifts. Simple as that. Pay comes through every week, no fuss.",
  },
  {
    icon: IconStar,
    title: "Build Your Reputation",
    desc: "Be reliable, do good work, and you'll get first pick of the best shifts. Many of our temps have been with us for years.",
  },
];
...
const requirements = [
  ...
  },
  {
    icon: IconFileText,
    label: "Right to Work",
    desc: "Proof of your right to work in the UK",
  },
  {
    icon: IconHome,
  ...
  return (
    <section className="relative flex min-h-[70vh] w-full items-center justify-center overflow-hidden bg-navy-900 pt-32 pb-24">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
        ...
        >
          Consistent shifts, weekly pay, and opportunities across Leicester.
          Warehouse, manufacturing, and logistics roles available.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            Register Now <IconArrowRight size={18} />
          </Link>
          <Link
            href="/jobs"
          ...
          {whyUs.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card group relative overflow-hidden rounded-2xl p-10 transition-all duration-300 hover:border-teal-5/30 hover:teal-glow-sm text-center"
              >
                <div className="w-16 h-16 rounded-2xl bg-teal-5/10 flex items-center justify-center mx-auto mb-8 group-hover:bg-[#00A99D] group-hover:text-white transition-all text-teal-5">
                  <Icon size={32} />
                </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-14 h-14 rounded-2xl bg-teal-5/10 flex items-center justify-center text-teal-5 group-hover:bg-[#00A99D] group-hover:text-white transition-all">
                    <Icon size={28} />
                  </div>
                  <h4 className="text-white text-2xl font-semibold tracking-tight">
                    {opp.title}
                  </h4>
                </div>
                  ...
                  {opp.roles.map((role, j) => (
                    <div key={j} className="flex items-center gap-3">
                      <IconCheck
                        ...
                        strokeWidth={3}
                      />
                      <span className="text-[#8B98AB] font-medium">{role}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center shrink-0">
                  <div className="w-14 h-14 rounded-full bg-teal-5 text-black font-semibold text-lg flex items-center justify-center shadow-lg shadow-teal-5/20">
                    {i + 1}
                  </div>
                  {i < steps.length - 1 && (
    ...
    <section className="py-24 bg-[#0d111a]">
      <div className="mx-auto max-w-5xl px-6">
        <div className="glass-card rounded-2xl p-12 md:p-20 relative overflow-hidden">
          ...
          <h3 className="relative text-white text-3xl md:text-5xl font-semibold mb-4 tracking-tight">
            What You Need to Register
          </h3>
          <p className="relative text-[#8B98AB] text-lg font-medium mb-12">
          ...
          <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            {requirements.map((req, i) => {
              ...
              return (
                <div
                  key={i}
                  className="flex items-start gap-4 bg-white/[0.03] border border-white/5 rounded-2xl p-6"
                >
                  ...
                  <div>
                    ...
                    <div className="text-[#8B98AB] text-sm font-medium">
                      {req.desc}
                    </div>
                  </div>
                </div>
          ...
          <p className="relative text-[#8B98AB]/50 text-sm font-medium italic">
            Additional for specific roles: Forklift license, food safety
            certificate, or DBS check (we&apos;ll advise based on the role)
          </p>
        </div>
      </div>
    </section>
  ...
  return (
    <main className="bg-navy-900 min-h-screen">
      ...
      <CtaBanner
        ...
        subtitle="Register today and start getting shifts this week."
