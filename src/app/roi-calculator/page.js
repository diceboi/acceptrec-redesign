  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center text-sm font-bold tracking-tight">
        <span className="text-[#8B98AB] uppercase text-[10px] tracking-widest">{label}</span>
...
function RoiInput({ label, value, onChange, prefix = "" }) {
  return (
    <div className="space-y-3">
      <span className="text-[#8B98AB] uppercase text-[10px] tracking-widest font-bold block">{label}</span>
...
export default function RoiCalculator() {
  ...
  const results = useMemo(() => {
    ...
    const currentHiddenCosts = totalSavings * 1.15;

    return { annualHours, noShowSavings, fillRateSavings, turnoverSavings, mgmtTimeSavings, totalSavings, currentHiddenCosts };
  ...
  return (
    <main className="bg-navy-900 min-h-screen font-sans">
      ...
      {/* Hero */}
      <section className="relative flex min-h-[80vh] w-full flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1140px] px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {[
                  ...
                  <div key={i} className="glass-card group relative overflow-hidden rounded-2xl p-8 transition-all duration-300 hover:border-teal-5/30 hover:teal-glow-sm">
                    ...
                    <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-[#00A99D] text-white mb-6">
                      <item.icon size={20} />
                    </div>
            ...
            <div className="lg:col-span-5 h-fit lg:sticky lg:top-32">
              <motion.div
                className="glass-card relative overflow-hidden rounded-2xl border-teal-5/20"
                initial={{ scale: 0.95 }} animate={{ scale: 1 }}
              >
                <div className="absolute top-0 right-0 h-40 w-40 bg-teal-5/5 blur-[80px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
                ...
                <div className="p-10 md:p-12 relative z-10">
                  ...
                  <div className="space-y-6 pt-10 border-t border-white/5">
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-[#8B98AB] font-medium">Your current hidden costs:</span>
                      <span className="text-red-400 font-bold">£{results.currentHiddenCosts.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-[#8B98AB] font-medium">Estimated ROI improvement:</span>
                      <span className="text-teal-5 font-bold">+28.5%</span>
                    </div>
                  </div>

                  <Button variant="primary" size="lg" className="w-full mt-12 py-8 text-lg font-bold group" href="/get-started">
                    Send Full Report <IconArrowRight size={20} className="ml-2 group-hover:translate-x-1 transition-transform" />
                  </Button>

                  <p className="mt-8 text-center text-[#8B98AB] text-[10px] uppercase font-bold leading-relaxed max-w-[240px] mx-auto">
      ...
      <section className="py-24 bg-navy-700 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1140px] px-6">
          ...
          <div className="mx-auto max-w-[900px] space-y-12">
            {[
              { label: "Fill Rate", accept: "98%", industry: "75%" },
              { label: "No-Show Rate", accept: "2%", industry: "8%" },
              { label: "Monthly Turnover", accept: "8%", industry: "25%" },
            ].map((row, i) => (
              <div key={i} className="space-y-4">
                <div className="flex justify-between font-bold text-sm uppercase tracking-widest px-1">
                  <span className="text-[#8B98AB]">{row.label}</span>
                ...
                <div className="flex justify-between text-[11px] font-bold text-[#8B98AB]/50 uppercase tracking-widest px-1">
