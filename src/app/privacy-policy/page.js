...
const sections = [
    ...
    },
    {
        ...
        content: [
            ...
            "Website: ico.org.uk",
            "—",
            "Disclaimer: This privacy notice has been prepared as a structured first draft. It does not constitute legal advice. The wording must be reviewed and signed off by a qualified data protection professional before publication."
        ]
    }
];
            ...
            <section className="relative flex min-h-[50vh] w-full items-center justify-center overflow-hidden bg-navy-900 pt-32 pb-16">
                ...
                <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                        ...
                        <h1 className="font-sans text-5xl font-semibold leading-[1.05] tracking-tight text-white md:text-6xl lg:text-7xl mb-8">Privacy Notice</h1>
                        <p className="text-[#8B98AB] text-xl leading-relaxed font-medium max-w-2xl mx-auto">Version 5.0 — April 2026</p>
                    </motion.div>
                </div>
            ...
            <section className="pb-32 bg-navy-700">
                <div className="mx-auto max-w-4xl px-6">
                    <div className="glass-card rounded-2xl p-10 md:p-16 mb-8">
                        <p className="text-[#8B98AB] leading-relaxed font-medium">Accept Recruitment Limited (&ldquo;Accept&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;) respects your privacy and is committed to protecting your personal data. This notice explains how we collect, use, share and protect personal data in connection with our recruitment services and our workforce management platform, AcceptPulse.</p>
                    </div>
                        ...
                        {sections.map((s, i) => (
                            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card rounded-2xl p-8 md:p-10">
                                ...
                                <div className="space-y-4">
                                    {s.content.map((p, j) => {
                                        if (p.startsWith("### ")) {
                                            return <h4 key={j} className="text-white text-lg font-medium mt-6 mb-2">{p.replace("### ", "")}</h4>;
                                        }
                                        return <p key={j} className={`text-[#8B98AB] leading-relaxed font-medium ${p.startsWith("•") ? "pl-4" : ""}`}>{p}</p>;
                                    })}
                                </div>
                            </motion.div>
                        ))}
