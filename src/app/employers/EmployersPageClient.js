      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6 text-center">
        ...
        >
          ...
          <span className="text-sm font-semibold text-teal-4">
            For Employers — Performance Staffing
          </span>
        </motion.div>
        <motion.h1
        ...
        >
          ...
          <span className="text-teal-5 italic">Mediocre Temps.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Other agencies send whoever&apos;s available. We send workers who are
          rated, coached, and rewarded for performance. Better temps, not just
          more temps.
        </motion.p>
        <motion.div
...
function ValuePillars() {
  const pillars = [
    {
      t: "Rated Every Shift",
      d: "Every worker receives a 1-5 star rating after every shift. Total transparency on quality.",
      i: IconStar,
    },
    {
      t: "Coached to Improve",
      d: "Data-driven feedback loops identify issues and trigger automated coaching.",
      i: IconSchool,
    },
    {
      t: "Rewarded for Results",
      d: "Top performers earn points and rewards, incentivising them to work harder for you.",
      i: IconTrophy,
    },
  ];
...
function ComparisonSection() {
  const comparisons = [
    {
      prob: "Workers doing the bare minimum.",
      solution: "Every shift rated 1-5 stars.",
      icon: IconStar,
    },
    {
      prob: "Same problems every week.",
      solution: "Feedback that creates change.",
      icon: IconRefresh,
    },
    {
      prob: "Zero incentive to excel.",
      solution: "Top performers rewarded.",
      icon: IconTrophy,
    },
    {
      prob: "Supervisors babysitting all day.",
      solution: "Pre-trained, self-managing workers.",
    ...
    <section className="relative w-full bg-navy-700 py-16 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
          {stats.map((s, i) => (
            <div key={i}>
              <div className="text-teal-4 font-semibold text-4xl md:text-5xl mb-2 tabular-nums">
                {s.val}
              </div>
          ...
          {cases.map((c, i) => (
            ...
            >
              ...
              <div className="relative flex justify-between items-start mb-10">
                ...
                <span className="text-[10px] font-semibold text-[#8B98AB]/70 uppercase tracking-widest">
                  {c.tag}
                </span>
              </div>
              ...
              <p className="relative text-teal-4 font-semibold text-lg mb-6 leading-tight">
                {c.target}
              </p>
              <p className="relative text-[#8B98AB] text-sm leading-relaxed mb-8 flex-grow">
                {c.desc}
              </p>
              <div className="relative pt-6 border-t border-white/5">
                <div className="text-xs font-semibold text-[#8B98AB]/70 uppercase tracking-widest mb-1">
                  Key Growth
                </div>
